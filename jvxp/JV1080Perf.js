...
const fxSrcOptions = (
  ...
  ([1, 10]).rangeMap(i => `Part ${i}`)
).concat(
  ([10, 16]).rangeMap(i => `Part ${i+1}`)  
)
...
const commonParms = [
  ...
  { inc: 1, b: 0x1a, block: [
    ...
    ['fx/chorus', { }],
    ['fx/reverb', { }],
    ['fx/ctrl/src/0', { opts: Voice.fxControlSources }],
    ['fx/ctrl/depth/0', { max: 126, dispOff: -63 }],
    ['fx/ctrl/src/1', { opts: Voice.fxControlSources }],
    ...
    ['chorus/predelay', { }],
    ['chorus/feedback', { }],
    ['chorus/out/assign', { opts: Voice.chorusOuts }],
    ['reverb/type', { opts: Voice.reverbTypes }],
    ['reverb/level', { }],
    ['reverb/time', { }],
    ['reverb/hfdamp', { opts: Voice.reverbHFDamps }],
    ['reverb/feedback', { }],
    ['tempo', { packIso: JVXP.multiPack(0x2d), rng: [20, 251] }],
  ] },
  ['key/range', { b: 0x2f, max: 1 }],
  { prefix: "part", count: 16, bx: 1, block: [
    ['voice/reserve', { b: 0x30, max: 64 }],
  ] },
]
...
const partParms = [
  ...
  { inc: 1, b: 0x06, block: [
    ...
    ['out/assign', { opts: ["Mix","FX","Output 1","Output 2","Patch"] }],
    ['out/level', { }],
    ['chorus', { }],
    ['reverb', { }],
    ['rcv/pgmChange', { max: 1 }],
...
const partPatchWerk = JVXP.perfPartPatchWerk(partParms, 0x13)
