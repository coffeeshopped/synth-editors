...
const editorTruss = (name, deviceId, files) => {
  ...
  return {
    ...
    map: ([
      // ['deviceId'],
      ['global', 0x0000, global.patchWerk],
      ['perf', 0x01000000, perf.patchWerk],
      ['patch', 0x03000000, voice.patchWerk],
      ['rhythm', 0x02090000, rhythm.patchWerk],
      ['bank/patch/0', 0x11000000, voice.bankWerk],
      ['bank/perf/0', 0x10000000, perf.bankWerk],
