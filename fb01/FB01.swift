...
public enum FB01 {
  ...
  static func paramData(channel: Int, instrument: Int, bodyBytes: [UInt8]) -> [UInt8] {
    Yamaha.sysex([0x75, UInt8(channel), 0x18 + UInt8(instrument)] + bodyBytes)
  }
  
  static let voiceRamBanks: [[String]] = [
