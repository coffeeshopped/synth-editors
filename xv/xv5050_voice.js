...
const outAssignOptions = Array.sparse([
  [0, "MFX"],
  [1, "A"],
  [2, "B"],
  [5, "1"],
...
const mtrxSrcOptions = Array.sparse([
  [0, "Off"],
  [96, "Bend"],
  [97, "Aftertouch"],
  [98, "System 1"],
...
//    ['oneShot', { b: 0x21, max: 1 }],
  ...
  { prefix: "mtrx/ctrl", count: 4, bx: 9, block: [
    ['src', { b: 0x2b, opts: mtrxSrcOptions }],
    { prefix: "dest", count: 4, bx: 2, block: [
      ['', { b: 0x2c, opts: mtrxDestOptions }],
    ] },
    { prefix: "amt", count: 4, bx: 2, block: [
      ['', { b: 0x2d, rng: [1, 127], dispOff: -64 }],
    ] },
  ] },
]
...
const internalWaveGroupOptions = Array.sparse([
  [0, "Off"],
  [1, "Internal"],
])
...
const toneParms = [
  ...
  { prefix: "ctrl", count: 4, bx: 4, block: [
    { prefix: "on", count: 4, bx: 1, block: [
      ['', { b: 0x17, opts: ["Off", "On", "Reverse"] }],
    ] },
  ] },
  ...
  { prefix: "lfo", count: 2, bx: 14, block: (index, offset) => [
...
const structureOptions = (10).map(i => `xv-struct-${i+1}`)
...
const toneMixParms = [
  ...
  { prefix: "tone", count: 4, bx: 9, block: [
    ['on', { b: 0x05, max: 1 }],
    ['key/lo', { b: 0x06, iso: ['noteName', "C-1"] }],
    ['key/hi', { b: 0x07, iso: ['noteName', "C-1"] }],
    ['key/fade/lo', { b: 0x08 }],
    ['key/fade/hi', { b: 0x09 }],
...
const toneMixPatchWerk = {
  single: "Voice Tone Mix", 
  parms: toneMixParms, 
  size: 0x29, 
  // randomize: {
...
const patchWerk = XVVoice.patchWerk(common: Common.patchWerk, tone: Tone.patchWerk, fx: FX.patchWerk, chorus: Chorus.patchWerk, reverb: Reverb.patchWerk, initFile: "xv5050-voice-init")
