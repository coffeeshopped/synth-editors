...
extension XV {
  ...
  struct FX {
    ...
    const gainParam = xvrange(-15...15)
    const fx200to8kOptions = ["200", "250", "315", "400", "500", "630", "800", "1000", "1250", "1600", "2000", "2500", "3150", "4000", "5000", "6300", "8000"]
    const fx200to8kParam = xvoptions(fx200to8kOptions)
    const fx200to8kBypassParam = xvoptions(fx200to8kOptions + ["Bypass"])
    const eqQParam = xvoptions(["0.5", "1.0", "2.0", "4.0", "9.0" ])
    ...
    const filterTypeParam = xvoptions(["Off","LPF","HPF"])
    const coarseParam = xvrange(-24...12)
    const fineParam = xvoptions(101.map {"\($0*2 - 100)"})
    const fdbkParam = xvoptions(99.map {"\($0*2 - 98)"})
    const balanceParam = xvoptions(101.map {"D\(100-$0):\($0)W"})
    const phaseParam = xvoptions(91.map {"\($0 * 2)"})
    const delayTime500Param = xvmiso(0...126, Miso.piecewise(breaks: [
      (0, 0),
      (50, 5),
      (60, 10),
      (90, 40),
    ...
    const delayTime100Param = xvmiso(0...125, Miso.piecewise(breaks: [
      (0, 0),
      (50, 5),
      (60, 10),
      (100, 50),
    ...
    const fxPhaserManualOptions = xvoptions({
    ...
    const offOnParam = xvoptions(["Off","On"])
    const vowelParam = xvoptions(["a","e","i","o","u"])
    const postGainParam = xvoptions(["0","+6","+12","+18"])
    const limitRatioParam = xvoptions(["1.5:1","2:1","4:1","100:1"])
    const threeDOutParam = xvoptions(["Speaker","Phones"])
    const modWaveParam = xvoptions(["Tri","Squ","Sin","Saw 1","Saw 2"])
    const accelParam =  xvrange(0...15)
    const midQParam = xvoptions(["0.5","1.0","2.0","4.0","8.0"])
    const speakerSimParam = xvoptions(["Small 1","Small 2","Middle","JC-120","Built In 1", "Built In 2", "Built In 3", "Built In 4", "Built In 5","BG Stack 1", "BG Stack 2", "MS Stack 1", "MS Stack 2", "Metal Stack", "2-Stack", "3-Stack"])
    const ampSimpleParam = xvoptions(["Small", "Built-in", "2 Stack", "3 Stack"])
    const ampSimParam = xvoptions(["JC-120", "Clean Twin", "Match Drive", "BG Lead", "MS1959I", "MS1959II", "MS1959I+II", "SLDN Lead", "Metal 5150", "Metal Lead", "OD-1", "OD-2 Turbo", "Distortion", "Fuzz"])
    const odDistParam = xvoptions(["OD", "Dist"])
    const choFlgParam = xvoptions(["Chorus", "Flanger"])
    const isolatorGainParam = xvrange(-60...4)
    const defaultRangeParam = xvrange()
    ...
    const phaserRateOptions = xvmiso(1...(200 + noteOptions.count), Miso.switcher([
    ...
    const delayTime1000Param = xvoptions({
      var options = (0..<70).map { "\(200 + $0 * 5)" }
      options += (0...45).map { "\(550 + $0 * 10)" }
      options += noteOptions[6..<16]
      return options
      }())
    const delayTime1000NoNoteParam = xvoptions({
      var options = (0..<70).map { "\(200 + $0 * 5)" }
      options += (0...45).map { "\(550 + $0 * 10)" }
      return options
      }())
    const gateTimeParam = xvoptions({
      var options = (1...100).map { "\($0 * 5)" }
      return options
      }())
    const delayTime1800Param = xvoptions({
      var options = (0...1800).map { "\($0)" }
      options += noteOptions
      return options
      }())
    const delayTime900Param = xvoptions({
      var options = (0...900).map { "\($0)" }
      options += noteOptions
      return options
      }())
    const delayTime3000Param = xvoptions({
      var options = (0...3000).map { "\($0)" }
      options += noteOptions
      return options
      }())
    const delayTime1500Param = xvoptions({
      var options = (0...1500).map { "\($0)" }
      options += noteOptions
      return options
      }())
    const azimuthParam = xvoptions({
    ...
    const off = Self.init(name: "Through", params: [:], dests: [])
    const eq = Self.init(name: "Stereo Eq", params: [
    ...
    const overdrive = Self.init(name: "Overdrive", params: [
    ...
    const distortion = Self.init(name: "Distortion", params: overdrive.params, dests: overdrive.dests)
    const phaser = Self.init(name: "Phaser", params: [
    ...
    const spectrum = Self.init(name: "Spectrum", params: [
      0 : ("250Hz", gainParam),
      1 : ("500Hz", gainParam),
      2 : ("1000Hz", gainParam),
      3 : ("1250Hz", gainParam),
    ...
    const enhancer = Self.init(name: "Enhancer", params: [
    ...
    const autowah = Self.init(name: "Auto Wah", params: [
    ...
    const rotary = Self.init(name: "Rotary", params: [
      0 : ("Hi Slow", rateParam),
    ...
    const compressor = Self.init(name: "Compressor", params: [
    ...
    const limiter = Self.init(name: "Limiter", params: [
    ...
    const hexaChorus = Self.init(name: "Hexa-chorus", params: [
    ...
    const tremChorus = Self.init(name: "Tremolo Cho", params: [
      0 : ("Pre Delay", delayTime100Param),
    ...
    const spaceD = Self.init(name: "Space-D", params: [
      0 : ("Pre Delay", delayTime100Param),
      1 : ("Cho Rate", rateParam),
      2 : ("Cho Depth", defaultRangeParam),
    ...
    const chorus = Self.init(name: "St Chorus", params: [
    ...
    const flanger = Self.init(name: "Stereo Flanger", params: [
      0 : ("Filter", filterTypeParam),
      1 : ("Cutoff", fx200to8kParam),
      2 : ("Pre Delay", delayTime100Param),
      3 : ("Rate", rateParam),
    ...
    const stepFlanger = Self.init(name: "Step Flanger", params: [
      0 : ("Pre Delay", delayTime100Param),
      1 : ("Rate", rateParam),
      2 : ("Depth", defaultRangeParam),
    ...
    const stDelay = Self.init(name: "Stereo Delay", params: [
    ...
    const modDelay = Self.init(name: "Mod Delay", params: [
      0 : ("Mode", xvoptions(["Normal","Cross"])),
      1 : ("Delay L", delayTime500Param),
      2 : ("Delay R", delayTime500Param),
      3 : ("Feedback", fdbkParam),
    ...
    const tripleDelay = Self.init(name: "3 Tap Delay", params: [
    ...
    const quadDelay = Self.init(name: "4 Tap Delay", params: [
    ...
    const timeCtrlDelay = Self.init(name: "Tm Ctrl Dly", params: [
    ...
    const duoPitchShift = Self.init(name: "2V pch Shift", params: [
      0 : ("Mode", xvrange(1...5)),
    ...
    const feedbackPitchShift = Self.init(name: "Fb pch Shift", params: [
      0 : ("Mode", xvrange(1...5)),
    ...
    const reverb = Self.init(name: "Reverb", params: [
    ...
    const gateVerb = Self.init(name: "Gated Reverb", params: [
    ...
    const odChorus = Self.init(name: "OD → Chorus", params: [
      0 : ("Drive", defaultRangeParam),
      1 : ("OD Pan", panParam),
      2 : ("Pre Delay", delayTime100Param),
      3 : ("Rate", rateParam),
    ...
    const odFlanger = Self.init(name: "OD → Flanger", params: [
      0 : ("Drive", defaultRangeParam),
      1 : ("OD Pan", panParam),
      2 : ("Pre Delay", delayTime100Param),
      3 : ("Rate", rateParam),
    ...
    const odDelay = Self.init(name: "OD → Delay", params: [
      0 : ("Drive", defaultRangeParam),
      1 : ("OD Pan", panParam),
    ...
    const distChorus = Self.init(name: "Dist → Chorus", params: odChorus.params, dests: odChorus.dests)
    const distFlanger = Self.init(name: "Dist → Flanger", params: odFlanger.params, dests: odFlanger.dests)
    const distDelay = Self.init(name: "Dist → Delay", params: odDelay.params, dests: odDelay.dests)
    const enhanceChorus = Self.init(name: "Enh → Chorus", params: [
      0 : ("Sens", defaultRangeParam),
      1 : ("Mix", defaultRangeParam),
      2 : ("Pre Delay", delayTime100Param),
      3 : ("Rate", rateParam),
    ...
    const enhanceFlanger = Self.init(name: "Enh → Flanger", params: [
      0 : ("Sens", defaultRangeParam),
      1 : ("Mix", defaultRangeParam),
      2 : ("Pre Delay", delayTime100Param),
      3 : ("Rate", rateParam),
    ...
    const enhanceDelay = Self.init(name: "Enh → Delay", params: [
      0 : ("Sens", defaultRangeParam),
      1 : ("Mix", defaultRangeParam),
      2 : ("Delay", delayTime500Param),
      3 : ("Feedback", fdbkParam),
    ...
    const chorusDelay = Self.init(name: "Chorus → Delay", params: [
    ...
    const flangerDelay = Self.init(name: "Flg → Delay", params: [
    ...
    const chorusFlanger = Self.init(name: "Cho → Flanger", params: [
      0 : ("Cho Delay", delayTime100Param),
      1 : ("Cho Rate", rateParam),
      2 : ("Cho Depth", defaultRangeParam),
    ...
    const chorusAndDelay = Self.init(name: "Chorus/Delay", params: chorusDelay.params, dests: chorusDelay.dests)
    const flangerAndDelay = Self.init(name: "Flg/Delay", params: flangerDelay.params, dests: flangerDelay.dests)
    const chorusAndFlanger = Self.init(name: "Cho/Flanger", params: chorusFlanger.params, dests: chorusFlanger.dests)
    const stPhaser = Self.init(name: "St Phaser", params: [
    ...
    const keySyncFlanger = Self.init(name: "Keysync Flg", params: [
      0 : ("Filter", filterTypeParam),
      1 : ("Cutoff", fx200to8kParam),
      2 : ("Pre Delay", delayTime100Param),
    ...
    const formantFilter = Self.init(name: "Formant Fltr", params: [
      0 : ("Drive", offOnParam),
    ...
    const ringMod = Self.init(name: "Ring Mod", params: [
    ...
    const multiTapDelay = Self.init(name: "Mlt tap Dly", params: [
    ...
    const reverseDelay = Self.init(name: "Reverse Dly", params: [
      0: ("Threshold", defaultRangeParam),
    ...
    const shuffleDelay = Self.init(name: "Shuffle Dly", params: [
    ...
    const threeDDelay = Self.init(name: "3D Delay", params: [
    ...
    const threeVoicePitchShift = Self.init(name: "3V pch Shift", params: [
      0 : ("Mode", xvrange(1...5)),
    ...
    const lofiComp = Self.init(name: "Lofi Comp", params: [
    ...
    const lofiNoise = Self.init(name: "Lofi Noise", params: [
    ...
    const speakerSim = Self.init(name: "Speaker Sim", params: [
    ...
    const overdrive2 = Self.init(name: "Overdrive 2", params: [
      0 : ("Drive", defaultRangeParam),
    ...
    const distortion2 = Self.init(name: "Distortion 2", params: overdrive2.params, dests: overdrive2.dests)
    const stComp = Self.init(name: "Stereo Comp", params: [
      0 : ("Sustain", defaultRangeParam),
      1 : ("Attack", defaultRangeParam),
    ...
    const stLimit = Self.init(name: "St Limiter", params: [
      0 : ("Threshold", defaultRangeParam),
      1 : ("Release", defaultRangeParam),
      2 : ("Ratio", limitRatioParam),
      3 : ("Post Gain", postGainParam),
    ...
    const gate = Self.init(name: "Gate", params: [
    ...
    const slicer = Self.init(name: "Slicer", params: [
    ...
    const isolator = Self.init(name: "Isolator", params: [
    ...
    const threeDChorus = Self.init(name: "3D Chorus", params: [
      0 : ("Filter", filterTypeParam),
      1 : ("Cutoff", fx200to8kParam),
      2 : ("Pre Delay", delayTime100Param),
      3 : ("LFO Rate", phaserRateOptions),
    ...
    const threeDFlanger = Self.init(name: "3D Flanger", params: [
      0 : ("Filter", filterTypeParam),
      1 : ("Cutoff", fx200to8kParam),
      2 : ("Pre Delay", delayTime100Param),
      3 : ("LFO Rate", phaserRateOptions),
    ...
    const tremolo = Self.init(name: "Tremolo", params: [
    ...
    const autoPan = Self.init(name: "Auto Pan", params: [
      0 : ("Mod Wave", modWaveParam),
      1 : ("Rate", phaserRateOptions),
      2 : ("Depth", defaultRangeParam),
      3 : ("Low Gain", gainParam),
    ...
    const stPhaser2 = Self.init(name: "St Phaser 2", params: [
      0 : ("Type", xvoptions(["1","2"])),
    ...
    const stAutoWah = Self.init(name: "St Auto Wah", params: [
      0 : ("Filter", xvoptions(["LPF","BPF"])),
      1 : ("Rate", phaserRateOptions),
      2 : ("Depth", defaultRangeParam),
      3 : ("Sens", defaultRangeParam),
    ...
    const stFormantFilter = Self.init(name: "St Formn Flt", params: [
      0 : ("Drive", offOnParam),
      1 : ("Drive", defaultRangeParam),
    ...
    const multiTapDelay2 = Self.init(name: "Mlt tap Dly2", params: [
    ...
    const reverseDelay2 = Self.init(name: "Reverse Dly2", params: [
      0 : ("Threshold", defaultRangeParam),
    ...
    const shuffleDelay2 = Self.init(name: "Shuffle Dly2", params: [
    ...
    const threeDDelay2 = Self.init(name: "3D Delay 2", params: [
    ...
    const rotary2 = Self.init(name: "Rotary 2", params: [
    ...
    const rotaryMulti = Self.init(name: "Rotary Multi", params: [
    ...
    const keyMulti = Self.init(name: "Keybd Multi", params: [
    ...
    const rhodesMulti = Self.init(name: "Rhodes Multi", params: [
    ...
    const jdMulti = Self.init(name: "Jd Multi", params: [
    ...
    const stLofiComp = Self.init(name: "St Lofi Comp", params: [
      0 : ("Pre Filter", xvrange(1...6)),
      1 : ("LoFi Type", xvrange(1...9)),
      2 : ("Post Filter 1", xvrange(1...6)),
      3 : ("Post Filter 2", filterTypeParam),
    ...
    const stLofiNoise = Self.init(name: "St Lofi Noiz", params: [
      0 : ("LoFi Type", xvrange(1...9)),
      1 : ("Post Filter", filterTypeParam),
      2 : ("Cutoff", fx200to8kParam),
      3 : ("Radio Detune", defaultRangeParam),
    ...
    const gtrAmpSim = Self.init(name: "Gtr amp Sim", params: [
    ...
    const stOverdrive = Self.init(name: "Stereo OD", params: [
      0 : ("Drive", defaultRangeParam),
      1 : ("Tone", defaultRangeParam),
      2 : ("Amp", offOnParam),
    ...
    const stDistortion = Self.init(name: "Stereo Dist", params: stOverdrive.params, dests: stOverdrive.dests)
    const gtrMultiA = Self.init(name: "Gtr Multi A", params: [
    ...
    const gtrMultiB = Self.init(name: "Gtr Multi B", params: [
      0 : ("Compressor", offOnParam),
      1 : ("Attack", defaultRangeParam),
      2 : ("Sustain", defaultRangeParam),
      3 : ("Cmp Level", defaultRangeParam),
    ...
    const gtrMultiC = Self.init(name: "Gtr Multi C", params: [
      0 : ("OD/Dist", offOnParam),
      1 : ("Type", odDistParam),
      2 : ("Drive", defaultRangeParam),
      3 : ("Tone", defaultRangeParam),
    ...
    const clGtrMltA = Self.init(name: "Cl Gtr Mlt A", params: [
      0 : ("Compressor", offOnParam),
      1 : ("Attack", defaultRangeParam),
      2 : ("Sustain", defaultRangeParam),
      3 : ("Cmp Level", defaultRangeParam),
    ...
    const clGtrMltB = Self.init(name: "Cl Gtr Mlt B", params: [
      0 : ("Wah", offOnParam),
    ...
    const bassMulti = Self.init(name: "Bass Multi", params: [
      0 : ("Compressor", offOnParam),
      1 : ("Attack", defaultRangeParam),
      2 : ("Sustain", defaultRangeParam),
      3 : ("Cmp Level", defaultRangeParam),
    ...
    const isolator2 = Self.init(name: "Isolator 2", params: [
    ...
    const stSpectrum = Self.init(name: "St Spectrum", params: [
      0 : ("250Hz", gainParam),
      1 : ("500Hz", gainParam),
      2 : ("1000Hz", gainParam),
      3 : ("1250Hz", gainParam),
    ...
    const threeDAutoSpin = Self.init(name: "3D Auto Spin", params: [
    ...
    const threeDManual = Self.init(name: "3D Manual", params: [
      0 : ("Azimuth", azimuthParam),
  ...
  enum Chorus {
    ...
    const delayParams: [Int:(String,Param)] = [
    ...
    const gm2Params: [Int:(String,Param)] = [
      0 : ("Level", xvrange()),
      1 : ("Feedback", xvrange()),
    ...
    const paramMap: [[Int:(String,Param)]] = [
      [:],
      chorusParams,
      delayParams,
      gm2Params
    ...
    const delayTimeParam = xvoptions(1001.map { "\($0)" } + FX.noteOptions)
  }
  ...
  enum Reverb {
    ...
    const srvParams: [Int:(String,Param)] = [
